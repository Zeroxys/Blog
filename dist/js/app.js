...
module.exports = function blogsContents(blog) {
  ...
  function render(blogContent) {
    return yo(_templateObject, blogContent[0].blog.imageUrl, moment(blogContent[0].createdAt).format('LL'), blogContent[0].blog.title, blogContent[0].blog.content, blog[0].liked ? 'liked' : '', like.bind(null, true), like.bind(null, false), blog[0].likes);
  }

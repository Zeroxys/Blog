...
module.exports = function blogsContents(blog) {
  ...
  function render(blogContent) {
    return yo(_templateObject, blogContent[0].blog.imageUrl, blogContent[0].blog.title, blogContent[0].blog.content, blog[0].liked ? 'liked' : '', like, dislike, blog[0].likes);
  }

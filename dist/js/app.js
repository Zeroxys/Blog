...
module.exports = function blogsContents(blog) {
  ...
  function render(blogContent) {
    return yo(_templateObject, blogContent[0].blog.imageUrl, blogContent[0].blog.title, blogContent[0].blog.content, blog[0].liked ? 'liked' : '', like.bind(null, true), like.bind(null, false), blog[0].likes);
  }
...
},{"./template.js":57,"axios":1,"empty-element":29,"page":37,"title":39}],57:[function(require,module,exports){
'use strict';
